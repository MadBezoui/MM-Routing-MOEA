...
def build_problem_factory(survey, comfort_predictor: TrainedComfortPredictor, n_var: int = 5, n_obj: int = 4):
    ...
    def _factory(profile, scenario: ScenarioConfig) -> ProfiledMultimodalProblem:
        return ProfiledMultimodalProblem(
            ...
            evaluator=evaluator,
            profile=profile, extras={}, scenario=scenario,
        )
...
def build_smart_plans(profiles_df: pd.DataFrame, sms_seeds: int = 5) -> List[SmartRunPlan]:
    ...
    return [
        SmartRunPlan(
            ...
            seeds_by_algorithm={
                "nsga2": tuple(range(30)),
                "nsga3": tuple(range(30)),
            },
        ...
        SmartRunPlan(
            ...
            seeds_by_algorithm={
                "nsga2": tuple(range(10)),
                "nsga3": tuple(range(10)),
                "moead": tuple(range(10)),
